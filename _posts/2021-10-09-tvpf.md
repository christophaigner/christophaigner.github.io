...
- _"Is this task something you never ever want to do or see again?"_
...
- _”When’s the latest that I have to start thinking about this?"_
...
- _”Would it be more productive if someone else performed this task instead of me?"_
- _”Would it be more productive if I trained someone else to properly perform this task instead of me?"_
- _”Would it be more productive if I hired the right person to perform this task instead of me?"_
...
You should _do it now_ regardless of the value. This is more efficient than scheduling it.

#### 📑 Takes 5-15 minutes and has no deadline

You should _create a task/reminder_ with a specific date and time.

#### 🗓 Takes > 15 minutes or has a fixed deadline

You should _schedule a calendar event_ and then do it. The more valuable the task, the sooner it should be done.
